        ...
        <x-jet-form-section data-qa="form_user_create">
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="name" name="name" type="text" class="mt-1 block w-full" autocomplete="name" placeholder="Nom de l'usuari" required/>
                    <x-jet-input-error for="name" class="mt-2" />
                </div>
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="email" value="{{ __('Email') }}" />
                    <x-jet-input id="email" name="email" type="text" class="mt-1 block w-full" autocomplete="name" placeholder="usuari@casteaching.com" required/>
                    <x-jet-input-error for="email" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="password" value="{{ __('Password') }}" />
                    <x-jet-input id="password" name="password" type="password" class="mt-1 block w-full" autocomplete="name" required/>
...
{{--                                            </label>--}}
{{--                                            <div class="mt-1">--}}
{{--                                                <input required id="email" type="email" name="email" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="usuari@casteaching.com"></input>--}}
{{--                                            </div>--}}
{{--                                            <p class="mt-2 text-sm text-gray-500">--}}
{{--                                                Email--}}
{{--                                            </p>--}}
