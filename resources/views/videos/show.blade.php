<x-casteaching-layout>
    <div class="flex flex-col space-x-4 space-y-4 lg:space-x-4
    lg:space-y-4 xl:space-x-10 xl:space-y-5 2xl:space-x-20 2xl:space-y-10 items-center ">
            <iframe
        ...
        <h2 class="text-gray-900 uppercase font-bold text-2xl tracking-tighter">
            {{$video->title}}
        </h2>
